...
public class InvalidArguments extends org.apache.thrift.TException implements org.apache.thrift.TBase<InvalidArguments, InvalidArguments._Fields>, java.io.Serializable, Cloneable, Comparable<InvalidArguments> {
  ...
  private static final org.apache.thrift.protocol.TField WHICH_ARGUMENT_FIELD_DESC = new org.apache.thrift.protocol.TField("whichArgument", org.apache.thrift.protocol.TType.I32, (short)1);
  ...
  public int whichArgument; // required
  public java.lang.String why; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    WHICH_ARGUMENT((short)1, "whichArgument"),
    WHY((short)2, "why");
  ...
  private static final int __WHICHARGUMENT_ISSET_ID = 0;
  private byte __isset_bitfield = 0;
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.WHICH_ARGUMENT, new org.apache.thrift.meta_data.FieldMetaData("whichArgument", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public InvalidArguments(InvalidArguments other) {
    ...
    this.whichArgument = other.whichArgument;
    if (other.isSetWhy()) {
      this.why = other.why;
    }
  }
  ...
  @Override
  public void clear() {
    setWhichArgumentIsSet(false);
    this.whichArgument = 0;
    this.why = null;
  }

  public int getWhichArgument() {
    return this.whichArgument;
  }

  public InvalidArguments setWhichArgument(int whichArgument) {
    this.whichArgument = whichArgument;
    setWhichArgumentIsSet(true);
    return this;
  }

  public void unsetWhichArgument() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __WHICHARGUMENT_ISSET_ID);
  }

  /** Returns true if field whichArgument is set (has been assigned a value) and false otherwise */
  public boolean isSetWhichArgument() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __WHICHARGUMENT_ISSET_ID);
  }

  public void setWhichArgumentIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __WHICHARGUMENT_ISSET_ID, value);
  }
  ...
  public InvalidArguments setWhy(java.lang.String why) {
    this.why = why;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case WHICH_ARGUMENT:
      if (value == null) {
        ...
        setWhichArgument((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(InvalidArguments that) {
    ...
    boolean this_present_whichArgument = true;
    boolean that_present_whichArgument = true;
    if (this_present_whichArgument || that_present_whichArgument) {
      if (!(this_present_whichArgument && that_present_whichArgument))
        return false;
      if (this.whichArgument != that.whichArgument)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + whichArgument;
  ...
  public int compareTo(InvalidArguments other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetWhichArgument()).compareTo(other.isSetWhichArgument());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWhichArgument()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.whichArgument, other.whichArgument);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    sb.append("whichArgument:");
    sb.append(this.whichArgument);
    first = false;
    if (!first) sb.append(", ");
    sb.append("why:");
    if (this.why == null) {
  ...
  private static class InvalidArgumentsStandardScheme extends org.apache.thrift.scheme.StandardScheme<InvalidArguments> {
        ...
        switch (schemeField.id) {
          case 1: // WHICH_ARGUMENT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.whichArgument = iprot.readI32();
              struct.setWhichArgumentIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InvalidArguments struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(WHICH_ARGUMENT_FIELD_DESC);
      oprot.writeI32(struct.whichArgument);
      oprot.writeFieldEnd();
      if (struct.why != null) {
