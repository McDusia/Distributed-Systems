...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField MINIMAL_EARNINGS_FIELD_DESC = new org.apache.thrift.protocol.TField("minimalEarnings", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  public int minimalEarnings; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PESEL((short)3, "PESEL"),
    MINIMAL_EARNINGS((short)4, "minimalEarnings");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // PESEL
          return PESEL;
        case 4: // MINIMAL_EARNINGS
          return MINIMAL_EARNINGS;
        default:
          return null;
      }
    }
  ...
  private static final int __MINIMALEARNINGS_ISSET_ID = 1;
  ...
  static {
    ...
    tmpMap.put(_Fields.MINIMAL_EARNINGS, new org.apache.thrift.meta_data.FieldMetaData("minimalEarnings", org.apache.thrift.TFieldRequirementType.DEFAULT, 
    ...
    int minimalEarnings)
  {
    ...
    this.PESEL = PESEL;
    setPESELIsSet(true);
    this.minimalEarnings = minimalEarnings;
    setMinimalEarningsIsSet(true);
  }
  ...
  public Person(Person other) {
    ...
    this.minimalEarnings = other.minimalEarnings;
  }
  ...
  public void clear() {
    ...
    setPESELIsSet(false);
    this.PESEL = 0;
    setMinimalEarningsIsSet(false);
    this.minimalEarnings = 0;
  }
  ...
  public int getMinimalEarnings() {
    return this.minimalEarnings;
  }

  public Person setMinimalEarnings(int minimalEarnings) {
    this.minimalEarnings = minimalEarnings;
    setMinimalEarningsIsSet(true);
    return this;
  }

  public void unsetMinimalEarnings() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __MINIMALEARNINGS_ISSET_ID);
  }

  /** Returns true if field minimalEarnings is set (has been assigned a value) and false otherwise */
  public boolean isSetMinimalEarnings() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __MINIMALEARNINGS_ISSET_ID);
  }

  public void setMinimalEarningsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __MINIMALEARNINGS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case MINIMAL_EARNINGS:
      if (value == null) {
        unsetMinimalEarnings();
      } else {
        setMinimalEarnings((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_minimalEarnings = true;
    boolean that_present_minimalEarnings = true;
    if (this_present_minimalEarnings || that_present_minimalEarnings) {
      if (!(this_present_minimalEarnings && that_present_minimalEarnings))
        return false;
      if (this.minimalEarnings != that.minimalEarnings)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + minimalEarnings;
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetMinimalEarnings()).compareTo(other.isSetMinimalEarnings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMinimalEarnings()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.minimalEarnings, other.minimalEarnings);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("minimalEarnings:");
    sb.append(this.minimalEarnings);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class PersonStandardScheme extends org.apache.thrift.scheme.StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // MINIMAL_EARNINGS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.minimalEarnings = iprot.readI32();
              struct.setMinimalEarningsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(MINIMAL_EARNINGS_FIELD_DESC);
      oprot.writeI32(struct.minimalEarnings);
      oprot.writeFieldEnd();
  ...
  private static class PersonTupleScheme extends org.apache.thrift.scheme.TupleScheme<Person> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMinimalEarnings()) {
        optionals.set(3);
      }
